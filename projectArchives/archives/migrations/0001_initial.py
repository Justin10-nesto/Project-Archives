    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="archives.project"
            ),
        ),
    ]
